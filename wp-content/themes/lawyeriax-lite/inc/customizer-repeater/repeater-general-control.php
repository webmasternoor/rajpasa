...
class LawyeriaX_General_Repeater extends WP_Customize_Control {
    ...
    public function __construct( $manager, $id, $args = array() ) {
        ...
        $this->boxtitle   = __('LawyeriaX Lite','lawyeriax-lite');
    ...
    public function enqueue() {
        ...
        wp_enqueue_script( 'customizer-repeater-iconpicker-control', get_template_directory_uri() . '/inc/customizer-repeater/js/iconpicker-control.js', array( 'jquery' ), '1.0.0', true );
