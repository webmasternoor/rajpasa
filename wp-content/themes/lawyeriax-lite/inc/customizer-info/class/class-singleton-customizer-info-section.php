...
final class Customizer_Info_Singleton {
	...
	public function sections( $manager ) {
		...
		$manager->add_section( new Customizer_Info( $manager, 'lawyeriax_view_pro', array(
			'section_title' => __( 'View PRO version', 'lawyeriax-lite' ),
			'section_url' => 'https://themeisle.com/themes/lawyeriax/',
			'section_text' => __( 'Get it', 'lawyeriax-lite' ),
		) ) );
	}
