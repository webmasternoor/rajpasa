<div class="col-md-12">
    ...
    <div class="form-group required col-md-6" id="form-UpazillaCode-error">
        {!! Form::label("UpazillaCode","faname",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("UpazillaCode",null,["class"=>"form-control required","id"=>"focus"]) !!}
            <span id="UpazillaCode-error" class="help-block"></span>
        </div>
    </div>
...
<div class="form-group">
    <div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('upazilla/list')" class="btn btn-danger"><i
