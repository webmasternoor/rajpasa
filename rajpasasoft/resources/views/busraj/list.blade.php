...
//                    console.log(data);
                        $.each(data, function (index, subcatObj3p) {
                            $('#p_scents').append('<tr><td style="text-align: center">' + i + '</td><td style="text-align: center">' + subcatObj3p.bus_id + '</td><td style="text-align: center">' + subcatObj3p.company_id + '</td><td style="text-align: center">' + subcatObj3p.departure_time + '</td><td style="text-align: center">' + subcatObj3p.arrival_time + '</td><td style="text-align: center">' + subcatObj3p.departure_place + '</td><td style="text-align: center">' + subcatObj3p.arrival_place + '</td><td style="text-align: center">' + subcatObj3p.bus_type + '</td><td style="text-align: center">' + subcatObj3p.total_seat + '</td><td style="text-align: center">' + subcatObj3p.seat_fare + '</td><td style="text-align: center">' + subcatObj3p.facility + '</td><td><a class="btn btn-primary btn-xs" title="Edit" href="javascript:ajaxLoad(\'busraj/viewseats/' + subcatObj3p.id + '\')">View Seats</a></td></tr>');
                            i++;
                        });
