<div class="col-md-12">
   ...
   <div class="form-group required col-md-6" id="form-bus_type-error">
      ...
      <div class="form-group required col-md-6" id="form-total_seat-error">
        {!! Form::label("total_seat","Total Seat",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("total_seat",null,["class"=>"form-control required","id"=>"focus"]) !!}
            <span id="total_seat-error" class="help-block"></span>
        </div>
    </div>
     <div class="form-group required col-md-6" id="form-available_seat-error">
        {!! Form::label("available_seat","Available Seat",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("available_seat",null,["class"=>"form-control required","id"=>"focus"]) !!}
            <span id="available_seat-error" class="help-block"></span>
        </div>
    </div>
