...
<div class="col-md-12">
    ...
    <div class="form-group required col-md-6" id="form-BookingbCode-error">
        {!! Form::label("BookingbCode","faname",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("BookingbCode",null,["class"=>"form-control required","id"=>"focus"]) !!}
            <span id="BookingbCode-error" class="help-block"></span>
        </div>
    </div>
...
<div class="form-group">
    <div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('bookingb/list')" class="btn btn-danger"><i
