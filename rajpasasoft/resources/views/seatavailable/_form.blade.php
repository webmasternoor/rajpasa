<div class="col-md-12">
    ...
    <div class="form-group required col-md-6" id="form-SeatavailableCode-error">
        {!! Form::label("SeatavailableCode","প্রোডাক্টের নামঃ",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("SeatavailableCode",null,["class"=>"form-control required","id"=>"focus"]) !!}
            <span id="SeatavailableCode-error" class="help-block"></span>
        </div>
    </div>
...
<div class="form-group">
    <div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('seatavailable/list')" class="btn btn-danger"><i
