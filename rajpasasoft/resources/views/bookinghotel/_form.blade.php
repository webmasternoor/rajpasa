<div class="col-md-12">
    ...
    <div class="form-group required col-md-6" id="form-BookinghotelCode-error">
        {!! Form::label("BookinghotelCode","faname",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("BookinghotelCode",null,["class"=>"form-control required","id"=>"focus"]) !!}
            <span id="BookinghotelCode-error" class="help-block"></span>
        </div>
    </div>
...
<div class="form-group">
    <div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('bookinghotel/list')" class="btn btn-danger"><i
