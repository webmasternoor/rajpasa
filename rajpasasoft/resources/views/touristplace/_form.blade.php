<div class="col-md-12">
    ...
    <div class="form-group required col-md-6" id="form-district_id-error">
        {!! Form::label("district_id","District Name",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::select("district_id",$district_info,null,["class"=>"form-control required","id"=>"focus"]) !!}
            <!-- {!! Form::select("district_id",$district_info,null,["class"=>"form-control required","id"=>"focus"]) !!} -->
...
<div class="form-group">
    <div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('touristplace/list')" class="btn btn-danger"><i
